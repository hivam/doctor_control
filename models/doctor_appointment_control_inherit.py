...
class doctor_appointment(osv.osv):
	...
	def create_attentiont_control(self, cr, uid, doctor_appointment, modelo_crear,  context={}):
		"""
	...
	def generate_attentiont(self, cr, uid, ids, context={}):
		...
		if self.pool.get('doctor.doctor').modulo_instalado(cr, uid, 'doctor_psychology', context=context):	
			...
			if tipo_historia == 'doctor_psychology'  :
				attentiont_id = self.create_attentiont_control(cr, uid, doctor_appointment_variable, self.pool.get('doctor.psicologia'), context=context)
		...
		if self.pool.get('doctor.doctor').modulo_instalado(cr, uid, 'doctor_dental_care', context=context):
			...
			if tipo_historia == u'doctor_dental_care':
				attentiont_id = self.create_attentiont_control(cr, uid, doctor_appointment_variable, self.pool.get('doctor.hc.odontologia'), context=context)
		...
		if self.pool.get('doctor.doctor').modulo_instalado(cr, uid, 'doctor_biological_risk', context=context):
			...
			if tipo_historia == u'doctor_biological_risk':
				attentiont_id = self.create_attentiont_control(cr, uid, doctor_appointment_variable, self.pool.get('doctor.atencion.ries.bio'), context=context)
